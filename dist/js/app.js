...
function renderContent(domEl, theRoute, theContent) {
	...
	if (theRoute === 'flights') {
		...
		(function () {
			var buildFlightTemplate = function buildFlightTemplate(arrivalsApiData, departuresApiData) {
			...
			arrivals = _jquery2.default.getJSON('http://apis.is/flight?language=en&type=arrivals');
			departures = _jquery2.default.getJSON('http://apis.is/flight?language=en&type=departures');


			_jquery2.default.when(arrivals, departures).then(function (arrivalsData, departuresData) {
